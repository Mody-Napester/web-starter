...
@section('title') Resource | Edit @endsection
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Resource/Edit</h1>
    </div>
    ...
    <form action="{{ route('resource.update', $resource->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit '{{ getFromJson($resource->title , lang()) }}' resource</h6>
            </div>
            <div class="card-body">
                <div class="row">
