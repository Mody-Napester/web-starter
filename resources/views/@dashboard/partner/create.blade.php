...
@section('title') Partner | Create @endsection
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Partner/Create</h1>
    </div>
    ...
    <form action="{{ route('partner.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Create new partner</h6>
            </div>
            <div class="card-body">
                <div class="row">
