                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label class="mb-2" for="parent_id">{{ trans('page.Parent') }}</label>
                                    <select class="select2 form-control {{ $errors->has('parent_id') ? ' is-invalid' : '' }}" id="parent_id" name="parent_id">
                                        <option @if($resource->parent_id == 0) selected @endif value="0">{{ trans('page.No_Parent') }}</option>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control {{ $errors->has('is_active') ? ' is-invalid' : '' }}" id="is_active" name="is_active">
                                        <option @if($resource->is_active == 1) selected @endif value="1">{{ trans('global.Yes') }}</option>
                                        <option @if($resource->is_active == 0) selected @endif value="0">{{ trans('global.No') }}</option>
                                    </select>
