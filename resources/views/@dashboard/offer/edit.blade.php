...
@section('page_contents')
    ...
    <!-- Page Forms -->
    <form action="{{ route('offer.update', $resource->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')

        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit '{{ getFromJson($resource->title , lang()) }}' offer</h6>
            </div>
            <div class="card-body">
                <div class="row">
