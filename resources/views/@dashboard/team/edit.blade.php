...
@section('content')
    ...
    <!-- Page Forms -->
    <form action="{{ route('team.update', $resource->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')

        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit '{{ getFromJson($resource->title , lang()) }}' team</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="facebook_url" value="{{ $resource->facebook_url }}" id="facebook_url">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="twitter_url" value="{{ $resource->twitter_url }}" id="twitter_url">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="linkedin_url" value="{{ $resource->linkedin_url }}" id="linkedin_url">
